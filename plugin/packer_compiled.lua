...
_G.packer_plugins = {
  ...
  ["nvim-cmp"] = {
    after = { "cmp-cmdline", "cmp-tabnine", "cmp-treesitter", "cmp-nerdfont", "cmp_luasnip", "cmp-nvim-lsp-signature-help", "LuaSnip", "cmp-nvim-lua", "friendly-snippets", "cmp-emoji", "cmp-buffer", "cmp-path", "cmp-calc", "cmp-spell" },
